...
namespace dotless.Test.Unit.engine
{
    ...
    public class AltEngineFixture
    {
        ...
        {
            var engine = new AltEngine(".outer .inner > a:Hover { background: red; }");
        ...
        {
            var engine = new AltEngine(".test, .trial{ background: red; }");
        ...
        {
            var engine = new AltEngine(".outer{ .inner { background: red; } }");
            Assert.AreEqual(1, engine.CssDom.Elements.Count);
        }
        ...
        {
            var engine = new AltEngine(".outer{ background: blue; .inner { background: red; } }");
            Assert.AreEqual(2, engine.CssDom.Elements.Count);
        }
        ...
        {
            var engine = new AltEngine(@".outer{ .inner { background: red; }  background: blue;}
        ...
        public void Rand()
        {
            ...
            var engine = new AltEngine(File.ReadAllText(fileName));
